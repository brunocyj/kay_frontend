...
export default function MeusPedidosPage() {
  ...
  async function handleCancel(order: Order) {
    ...
    if (res.ok) {
      ...
      setCancelError(err.detail ?? "Não foi possível cancelar o pedido.");
    }
    setCancelling(false);
  }
    ...
    <>
              ...
              <div className="overflow-y-auto flex-1 px-6 py-5 flex flex-col gap-5">
                ...
                {selected.tracking_code && (
                  <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
                    <p className="text-xs font-semibold text-blue-600 mb-1">Código de rastreio</p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-400 mt-0.5">Acompanhe o status das suas compras</p>
        </div>

        {orders.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-16 flex flex-col items-center text-center gap-4">
            <Package size={40} className="text-gray-200" />
            <p className="text-sm text-gray-400">Você ainda não fez nenhum pedido.</p>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-sm font-medium text-gray-900">Pedido #{order.id}</span>
                  ...
                  <p className="text-xs text-gray-400 truncate">
                    ...
                    {order.tracking_code && " · Rastreio disponível"}
                  </p>
                </div>
